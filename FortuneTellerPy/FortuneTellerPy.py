...
print("{0} {1} will retire in {2} years with ${3} in the bank, \na vacation home {4}, and {5}.".format( first_name, last_name, years_to_retire, money_bank, vacation_home, transit))